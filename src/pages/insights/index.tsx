...
export default function Insights({ posts }: InsightsPageProps) {
  return (
    <>
      <Head>
        <title>Insights - Lane Consulting</title>
        <meta name="description" content="Latest insights and articles from Lane Consulting" />
      ...
      <div className="bg-white text-gray-900 font-sans min-h-screen">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4 text-gray-900">Lane Consulting Insights</h1>
          ...
          {posts.length === 0 ? (
            <div className="text-center text-gray-500 py-12">
              ...
              <p>
                <Link href="http://localhost:3333" className="text-purple-600 hover:underline">
                  Open Sanity Studio
                </Link>
              </p>
            </div>
          ...
          <div className="text-center mt-12">
            <Link href="/" className="text-purple-600 hover:underline flex items-center justify-center">
